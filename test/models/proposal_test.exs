defmodule TechForGoodHub.ProposalTest do
  ...
  @valid_attrs %{amount_applied: 42, development_stage: "some content", graphic_url: "some content", location: "some content", summary: "some content", video_transcript: "some content", video_url: "some content", website: "some content", status: "some content", region: "some content", year: 2017}
  @invalid_attrs %{}
